 ...
 *
 * @package WordPress
 * @subpackage Webbershop
 * @since Webber shop 1.0
 */
...
{
$to = 'pushan.chakraborty@webart.technology';
$subject = 'New bulk order';
$htmltobesent = '<table><th>Product</th><th>Qty</th><th>Price</th>';
    ...
    $items = $woocommerce->cart->get_cart();
        ...
        foreach($items as $item => $values) { 
           ...
           $htmltobesent .='<tr><td>'.$_product->get_title().'</td><td>'.$values['quantity'].'</td><td>'.$price.'</td></tr>';
        } 

        $htmltobesent .='</table>';
        $message = $htmltobesent;
